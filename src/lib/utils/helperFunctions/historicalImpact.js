...
/*
    ...
    - tight margins can receive up to +8
...
const calculateImpact = ({
    ...
    */
    ...
    /*
        ...
        Games decided by more than ten points receive
        no margin bonus.
    */
...
const calculateLongTermSignal = ({
    ...
    */
    ...
    /*
        Twelve games on each side provides full
        game-volume evidence.
    */
    ...
    /*
        A substantial focal-season fragment counts as
        half of a season for persistence purposes.
    */
    ...
    /*
        A substantial focal-season sample immediately
        adjacent to the game makes the breakpoint itself
        more convincing.

        This cannot push the component above 35.
    */
...
/*
    Same scoring method used by the site's ordinary
