...
export const tabs = [
    ...
    { icon: 'article', label: 'Blog', dest: '/blog', key: 'blog' },
    {
        ...
        children: [
            ...
            { icon: 'sports_football', label: 'Go to Sleeper', dest: `https://sleeper.app/leagues/${leagueID}` },
        ]
    },
    {
        icon: 'build', label: 'League Tools', nest: true, key: 'league_tools',
        children: [
            { icon: 'school', label: 'Future Prospects', dest: '/future-prospects' },
            { icon: 'insights', label: 'Owner Power Rating', dest: '/power-rating' },
        ]
    },
